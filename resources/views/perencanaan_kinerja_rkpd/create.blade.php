            ...
            <div class="card-body">
                ...
                <form
                    ...
                    <div class="mb-3">
                        ...
                        @isset($perencanaan_kinerja_rkpd)
                            <p class="text-muted mb-3">Click Here To <a
                                    href="{{ asset('uploads/' . $perencanaan_kinerja_rkpd->file) }}" target="_blank">Open
                                    File!</a></p>
                        @endisset
                        <input type="file" id="myDropify" name="file" @empty($perencanaan_kinerja_rkpd) required
                            @endisset />
                    </div>

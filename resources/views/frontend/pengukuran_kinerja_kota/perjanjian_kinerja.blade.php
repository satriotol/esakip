        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="text-right">
                    <button class="btn btn-primary" @click="getKotaPerjanjianKinerja()">Cari</button>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(data, index) in dataPerjanjianKinerja">
                            <td>
                                @{{ data.year }} | @{{ data.name }}
                            </td>
                            <td>
                ...
                <div v-if="dataPerjanjianKinerja.length == 0" class="text-center">
                    <img src="{{ asset('no-results.png') }}" style="height: 200px;"><br>
                    <h2>Data Tidak Ditemukan</h2>
                </div>
                <nav aria-label="Page navigation example" class="text-right">
                    <ul class="pagination">
                        <li class="page-item" :class="{ active: link.active }" v-for="link in paginationPerjanjianKinerja.links"
                            @click="getKotaPerjanjianKinerja(link.url)">
